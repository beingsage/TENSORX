...
from core.valuation_Engine.GraphSAGE.graphsage.models import SampleAndAggregate, SAGEInfo, Node2VecModel
from core.valuation_Engine.GraphSAGE.graphsage.minibatch import EdgeMinibatchIterator
from core.valuation_Engine.GraphSAGE.graphsage.neigh_samplers import UniformNeighborSampler
from core.valuation_Engine.GraphSAGE.graphsage.utils import load_data
...
def train(train_data, test_data=None):
    ...
    if FLAGS.save_embeddings:
        ...
        if FLAGS.model == "n2v":
            ...
            # run random walks
            from core.valuation_Engine.GraphSAGE.graphsage.utils import run_random_walks
